...
class OrderTests(APITestCase):
    def setUp(self):
        ...
        self.product2 = Product.objects.create(name='Iphone', description='Iphone 17 pro', price=1000,
                                               category=self.category1, stock=50)
        self.product3 = Product.objects.create(name='Samsung', description='Samsung s25 ultra', price=1000,
                                               category=self.category1, stock=50)
